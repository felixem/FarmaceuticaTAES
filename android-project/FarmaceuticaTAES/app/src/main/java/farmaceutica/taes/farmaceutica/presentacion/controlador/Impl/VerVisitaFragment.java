...
public class VerVisitaFragment extends BaseFragment{
    ...
    TextView txt_titulo_detalles_visita;
    ...
    public static VerVisitaFragment newInstance() {

        // Instantiate a new fragment
        VerVisitaFragment fragment = new VerVisitaFragment();
    ...
    {
        // custom dialog
        final Dialog dialog = new Dialog(VerVisitaFragment.this.getActivity(), R.style.AppTheme_Dialog);
